...
(assert (and (>= y_1_1 0) (<= y_1_1 6)))
(assert (and (>= y_1_2 0) (<= y_1_2 6)))
(assert (and (>= y_1_3 0) (<= y_1_3 6)))
...
(assert (and (>= y_1_1 2) (<= y_1_1 4)))
(assert (and (>= x_1_1 3) (<= x_1_1 4)))
(assert (and (>= y_1_2 2) (<= y_1_2 4)))
(assert (and (>= x_1_2 3) (<= x_1_2 4)))
(assert (and (>= y_1_3 2) (<= y_1_3 4)))
(assert (and (>= x_1_3 3) (<= x_1_3 4)))
