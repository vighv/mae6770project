...
(assert (and (>= prim_1_7 1) (<= prim_1_7 4)))
(assert (and (>= prim_1_8 1) (<= prim_1_8 4)))
(assert (and (>= prim_1_9 1) (<= prim_1_9 4)))
...
(assert (and (>= x_1_8 0) (<= x_1_8 10)))
(assert (and (>= x_1_9 0) (<= x_1_9 10)))
(assert (and (>= x_1_10 0) (<= x_1_10 10)))
...
(assert (and (>= y_1_8 0) (<= y_1_8 10)))
(assert (and (>= y_1_9 0) (<= y_1_9 10)))
(assert (and (>= y_1_10 0) (<= y_1_10 10)))
...
(and (= vel_i_1_7 0)
     ...
     (= x_f_1_7 0)
     (= y_f_1_7 1)
     (= cost_1_7 (/ 29875696041984 100000000000000))
...
(and (= vel_i_1_8 0)
     ...
     (= x_f_1_8 0)
     (= y_f_1_8 1)
     (= cost_1_8 (/ 29875696041984 100000000000000))
...
(and (= vel_i_1_9 0)
     ...
     (= x_f_1_9 0)
     (= y_f_1_9 1)
     (= cost_1_9 (/ 29875696041984 100000000000000))
...
(assert (= total_cost (+ cost_1_1 cost_1_2 cost_1_3 cost_1_4 cost_1_5 cost_1_6 cost_1_7 cost_1_8 cost_1_9)))
(assert (<= total_cost (/ 29875700 10000000)))
...
(assert (and (>= y_1_8 5) (<= y_1_8 10)))
(assert (and (>= y_1_9 5) (<= y_1_9 10)))
(assert (and (>= y_1_10 5) (<= y_1_10 10)))
